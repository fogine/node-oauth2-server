...
AuthenticateHandler.prototype.handle = function(request, response) {
  ...
  return Promise.bind(this)
    ...
    .tap(function(token) {
      ...
      return this.verifyScope(token, request);
    })
    .tap(function(token) {
...
AuthenticateHandler.prototype.verifyScope = function(accessToken, request) {
  return promisify(this.model.verifyScope, 3).call(this.model, accessToken, this.scope, request)
    .then(function(scope) {
      if (!scope) {
